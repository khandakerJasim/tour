...
import image from "./../../../assets/doctor/medical.jpg";
//import Aos from "aos";
      ...
      <div className=" container mt-14 relative mx-auto   ">
        ...
        <div className=" mx-auto mt-10   max-w-screen-md  ">
          <h1 className=" tracking-tight text-3xl font-bold opacity-80 ">
            Popular <span className="text-blue-700 opacity-90">Hospital</span>
          </h1>
          ...
          <form className="mt-7 pb-10 " action="">
            <div className="flex flex-col">
              ...
              <input
                className=" md:w-[700px] mt-2 h-12 p-2 rounded-md bg-gray-300 text-gray-800 w-auto hover:outline-none focus:outline-none focus:ring-1 focus:ring-gray-400 "
                type="text"
            ...
            <div className="flex mt-4 flex-col">
              ...
              <textarea
                className=" md:w-[700px] mt-2  p-2 rounded-md bg-gray-300 text-gray-800 w-auto hover:outline-none focus:outline-none focus:ring-1 focus:ring-gray-400 "
                id=""
                cols="30"
                rows="10"
                placeholder="message..."
            ...
            <button
              ...
              // data-aos="fade-up"
              // data-aos-delay="400"
              className="text-2xl font-extrabold text-center bg-red-500 text-white p-1 rounded-md m-auto  mt-6"
            >
              submit
            </button>
          </form>
